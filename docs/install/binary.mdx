...
A Debian package (.deb) is available from
[ghostty-debian](https://github.com/dariogriffo/ghostty-debian) on GitHub. After
downloading the .deb for your Ubuntu version from the
[Releases](https://github.com/dariogriffo/ghostty-debian/releases) page, install it
as below:
