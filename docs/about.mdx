...
[^2]: Linux uses GTK4 and Adwaita, so Ghostty will look and feel like
a GTK4 application which may or may not be "native" depending on your
desktop environment and definition of "native". See note 1 too.
