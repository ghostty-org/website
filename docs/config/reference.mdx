...
See the notes about adjustments in [`adjust-cell-width`](#adjust-cell-width)
...
Thickness in pixels or percentage adjustment of the underline. 
See the notes about adjustments in [`adjust-cell-width`](#adjust-cell-width)
...
Thickness in pixels or percentage adjustment of the overline. See the notes about adjustments in [`adjust-cell-width`](#adjust-cell-width)
